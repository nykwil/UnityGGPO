    ...
    public unsafe class QueryTester : MonoBehaviour {
        ...
        private BlobAssetReference<Collider> CreateCollider(UnityEngine.Mesh mesh, ColliderType type) {
            switch (type) {
                ...
                case ColliderType.Triangle: {
                        return PolygonCollider.CreateTriangle(mesh.vertices[0], mesh.vertices[1], mesh.vertices[2], filter);
                    }
                case ColliderType.Quad: {
                        ...
                        return PolygonCollider.CreateQuad(
                            ...
                            mesh.vertices[orderedIndices[3]], filter);
                    }
                ...
                case ColliderType.Convex: {
                        ...
                        BlobAssetReference<Collider> collider = ConvexCollider.Create(points, default, filter);
                        points.Dispose();
                        return collider;
                    }
                default:
        ...
        private void OnValidate() {
            filter = new CollisionFilter() {
                BelongsTo = (uint)BelongsTo.value,
                CollidesWith = (uint)CollidesWith.value,
        ...
        private void RunQueries() {
            ref PhysicsWorld world = ref DefaultWorld.GetExistingSystem<BuildPhysicsWorld>().PhysicsWorld;
