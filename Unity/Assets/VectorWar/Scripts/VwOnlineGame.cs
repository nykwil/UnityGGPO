...
//    public abstract class VwBaseGgpoGame : BaseGgpoGame {
...
//            Log($"vw_begin_game_callback {flags}");
...
//            Log($"vw_load_game_state_callback {data.Length}");
//            gs.FromBytes(data);
//            return true;
//        }
...
//            Log($"vw_save_game_state_callback {frame}");
...
//            Log($"vw_log_game_state {filename}");

//            var gamestate = new VwGameState();
