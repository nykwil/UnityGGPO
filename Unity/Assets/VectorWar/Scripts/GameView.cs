...
namespace VectorWar {
    public class GameView : MonoBehaviour {
        ...
        private ShipView[] shipViews = Array.Empty<ShipView>();
        private Transform[][] bulletLists;

        private void ResetView(GameState gs) {
        ...
        public void UpdateGameView(GameState gs, NonGameState ngs) {
            // OnStatus(ngs.status);
    ...
    //    private void UpdateGameView(GameState gs, NonGameState ngs) {
    //        // OnStatus(ngs.status);
    ...
    //    private string RenderChecksum(NonGameState.ChecksumInfo info) {
