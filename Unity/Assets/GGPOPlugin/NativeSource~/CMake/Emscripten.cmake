...
if (EMSCRIPTEN_FORCE_COMPILERS)
	...
	if (NOT CMAKE_C_COMPILER_VERSION) # Toolchain script is interpreted multiple times, so don't rerun the check if already done before.
		execute_process(COMMAND "${CMAKE_C_COMPILER}" -v --em-config ${EM_CONFIG} RESULT_VARIABLE _cmake_compiler_result ERROR_VARIABLE _cmake_compiler_output OUTPUT_QUIET)
		if (NOT _cmake_compiler_result EQUAL 0)
			message(FATAL_ERROR "Failed to fetch compiler version information with command \"'${CMAKE_C_COMPILER}' -v --em-config ${EM_CONFIG}\"! Process returned with error code ${_cmake_compiler_result} and error ${_cmake_compiler_output}.")
		endif()
